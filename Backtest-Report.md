...
**扩展到多事件类型:** 见 `Event-Aligned-Evaluation.md` —— 把评估锚定在 **111 个真实事件**(42 财报 · 62 insider/Form 4 · 7 thesis break)上,产出 coverage / 独有捕获 / 重复率 / lead-lag 的完整汇总表。核心:**66 个事件是价格-only 会漏、由 thesis 引擎或 smart-money overlay 捕获的**。
